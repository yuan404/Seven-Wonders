...
public class GUICard extends Group {
	public GUICard(BuyBoard buy, CommandOption com1, int i) {
		...
		green.addEventHandler(MouseEvent.MOUSE_EXITED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						green.setOpacity(0);
					}
				});
		green.addEventHandler(MouseEvent.MOUSE_CLICKED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						/*
		...
		brown.addEventHandler(MouseEvent.MOUSE_EXITED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						brown.setOpacity(0);
					}
				});
		green.addEventHandler(MouseEvent.MOUSE_ENTERED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						green.setOpacity(1);
					}
				});
		brown.addEventHandler(MouseEvent.MOUSE_ENTERED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						brown.setOpacity(1);
					}
				});
		green1.addEventHandler(MouseEvent.MOUSE_EXITED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						green1.setOpacity(0);
					}
				});
		green1.addEventHandler(MouseEvent.MOUSE_CLICKED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
		...
		brown1.addEventHandler(MouseEvent.MOUSE_EXITED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						brown1.setOpacity(0);
					}
				});
		green1.addEventHandler(MouseEvent.MOUSE_ENTERED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						green1.setOpacity(1);
					}
				});
		brown1.addEventHandler(MouseEvent.MOUSE_ENTERED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						brown1.setOpacity(1);
					}
				});
		green2.addEventHandler(MouseEvent.MOUSE_EXITED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						green2.setOpacity(0);
					}
				});
		green2.addEventHandler(MouseEvent.MOUSE_ENTERED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						green2.setOpacity(1);
					}
		...
		addEventHandler(MouseEvent.MOUSE_EXITED,
				new EventHandler<MouseEvent>() {
					public void handle(MouseEvent e) {
						if (e.getX() > 208 || e.getY() > 320 || e.getX() < 0
								|| e.getY() < 0) {
							setLayoutY(getLayoutY() + 10);
							chooser.setVisible(false);
							green.setVisible(false);
